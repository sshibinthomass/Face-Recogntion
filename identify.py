...
#Loading Images
obama_image = face_recognition.load_image_file("photos/balu.jpg")
biden_image = face_recognition.load_image_file("photos/mala.jpg")
shibin_image = face_recognition.load_image_file("photos/shibin.jpg")
